...
ggplot(aes(x = quality, color = I('white')), data = red_wine_ds)+
  geom_histogram(bins = 9)+ scale_x_continuous(breaks = seq(3, 8, 1))
...
Here 82.48 % of wine is of quality 5 or 6
...
ggplot( aes(x = quality, y = red_wine_ds$volatile.acidity,
...
ggplot( aes( x = quality, y = red_wine_ds$alcohol,
  color = as.factor(quality)), data = red_wine_ds)+
  geom_boxplot()+
  scale_x_continuous(breaks = seq(1, 10, 1))+
...
```{r echo=FALSE,warning=F}
ggplot( aes(x = quality, y = red_wine_ds$citric.acid,
  color = as.factor(quality)), data = red_wine_ds)+
  geom_boxplot()+
  scale_x_continuous(breaks = seq(1, 10, 1))+
...
```{r echo=FALSE, warning=F}
ggplot(aes(x = quality, y = red_wine_ds$sulphates, 
  color = as.factor(quality)), data = red_wine_ds)+
  geom_boxplot()+
  scale_x_continuous(breaks = seq(1, 10, 1))+
...
Correlation plot is an interesting plot. It gives a clear picture about correlation of metrics with each other.

Here, we have choosen circles to represent correlation. The larger and denser the circle higher will be the correlation among metrics on horizontal scale and vertical scale.

It clearly shows that these variable are correlated with quality of wine:


Metric              | Correlation Value(approx)
------------------- | -------------
Alcohol             | 0.5
...
ggplot( aes(x = quality, y = alcohol, color = sulphates.bucket),
  ...
  geom_jitter()+
  geom_smooth(method = "lm")+
  scale_color_brewer("sulphates", palette = 'Blues')+
  scale_x_continuous(breaks = seq(1, 10, 1))+
  xlab("Wine Quality")+
